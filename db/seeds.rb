...
Event.create(name: "Dumpling Making Class", price: 50, date: "July 2", time: "11AM-1PM", location: "Virtual: TBD", image: "https://ccs-course-images.s3.amazonaws.com/products/1605641438899-folded%20dumplings.jpg", user_id: User.all.sample.id, description: "Learm how to make pork stuffing, fold and wrap dumplings and mix your own sauce. Vegetarian options available.", category: "Class")
