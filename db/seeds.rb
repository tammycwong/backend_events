...
User.create(image: "https://awomensthing.org/wp-content/uploads/2018/02/A-Womens-Thing-Womens-New-Women-New-Yorkers-Dru-Blumensheid-real-people-real-lives-1200x803.jpg", username:"ohmysensesfail", password: "password", name: "Ariel P.", location: "New York, New York", interests: "lifting weight, biking, marathons, the yankees", password: "password")
User.create(image: "https://images.amcnetworks.com/bbcamerica.com/wp-content/uploads/2013/06/Hipster.jpg", username:"skye60918", name: "Bartosz M.", location: "Queens, New York", interests: "music, dance, movies, food", password: "password")
User.create(image: "https://s.wsj.net/public/resources/images/MK-CM687_MENSKI_GR_20140528161349.jpg", username:"marine718", name: "Seth C.", location: "Brooklyn, New York", interests: "food, diy projects, cycling", password: "password")
...
User.create(image: "https://coolmenshair.com/wp-content/uploads/black-man-bun-1.jpg", username:"bigpoppa917", name: "Jared F.", location: "Bronx, New York", interests: "vinyls, Bobby Darin, plants, wine", password: "password")
...
User.create(image: "https://data.whicdn.com/images/91402922/original.jpg", username:"hipsterlord", name: "Arrow", location: "Bronx, New York", interests: "vinyls, Bobby Darin, plants, wine", password: "password")
...
Event.create(name: "Chocolate Truffle Making Night", price: 60, date: "July 10, 2021", time: "6PM-8PM", location: "245 W 29th St, New York, New York 10001", image: "https://handletheheat.com/wp-content/uploads/2020/11/how-to-make-chocolate-truffles-SQUARE-1.jpg", user_id: User.all.sample.id, description: "A night of decadent creations under the watchful eyes of culinary masters.", category: "Class")
Event.create(name: "Let's Meditate New York", price: 0, date: "July 2, 2021", time: "9AM-10AM", location: "Zoom: TBD", image: "https://cdn.mindful.org/meditate-12.png", user_id: User.all.sample.id, description: "Led by Zenzel Washington", category: "Free")
...
Event.create(name: "Catalina Wine Mixer", price: 100, date: "July 18, 2021", time: "6PM-12AM", location: "156 W 38th St, New York, New York 10018", image: "https://www.pngkey.com/png/detail/152-1527178_its-the-fucking-catalina-wine-mixer-logo.png", user_id: User.all.sample.id, description: "Mixture of baby jesus and Fergie", category: "Nightlife")
...
Event.create(name: "Brunch in Soho", price: 0, date: "July 30, 2021", time: "12PM-3PM", location: "217 Bowery, New York, NY 10002", image: "https://www.thisissoho.co.uk/assets/images/things-to-do/Hovarda(1).jpg", user_id: User.all.sample.id, description: "Couple of the year: Bloody Mary and Eggs Benny", category: "Free")
...
Event.create(name: "Caribbean Fridays", price: 50, date: "July 2, 2021", time: "9PM-1AM",location: "225 East Houson St, New York, New York", image: "http://www.trinijunglejuice.com/events/2009/caribbean_fridays_ft.jpg", user_id: User.all.sample.id, description: "Dance the night away with live music, drinks and food!", category: "NightLife")
